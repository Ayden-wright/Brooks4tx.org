...
const records = [
  ...
  { kicker: 'Leadership in Practice', kickerColor: 'var(--red)', title: 'Training Organizations for Effective Leadership', desc: 'Guiding policy and operations with a hard focus on accountability and ethical outcomes in state and nonprofit agencies across Texas.' },
  { kicker: 'Scholarship', kickerColor: 'var(--red)', title: 'Peer-Reviewed Publications', desc: "Research grounded in evidence, integrity, and real-world impact — documenting the harm caused when courts and agencies violate parental rights." },
  ...
  return (
    <section id="leadership-record" className="section section-alt" role="region" aria-label="Leadership record">
      ...
      <div className="reveal cards-grid cards-grid-2 record-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginTop: '2rem' }}>
        {records.map((item, i) => (
          <div key={i} className="info-card reveal" style={{ background: 'white', padding: '2rem', borderRadius: '0', borderLeft: '4px solid var(--red)', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
      ...
      <div className="reveal highlight-banner" style={{ background: '#1c1917', color: 'white', padding: '2rem', borderRadius: '0', borderLeft: '5px solid var(--red)', marginTop: '1.5rem', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
